...
{
    generic_tools::ds::interval_tree_preallocated<std::string, int> tree;
    ...
    tree.AllocateNode(75, 100);
    tree.AllocateNode(50, 60);
    tree.AllocateNode(120, 130);
    tree.AllocateNode(105, 110);
